...
const imgRectangle301 = new URL('../assets/imgRectangle301.png', import.meta.url).href;
...
const imgRectangle222 = new URL('../assets/imgRectangle222.png', import.meta.url).href;
const imgRectangle220 = new URL('../assets/imgRectangle220.png', import.meta.url).href;
const imgRectangle224 = new URL('../assets/imgRectangle224.png', import.meta.url).href;
const imgRectangle225 = new URL('../assets/imgRectangle225.png', import.meta.url).href;
const imgRectangle226 = new URL('../assets/imgRectangle226.png', import.meta.url).href;
...
const imgEllipse7 = new URL('../assets/imgEllipse7.png', import.meta.url).href;
const imgEllipse8 = new URL('../assets/imgEllipse8.png', import.meta.url).href;
const imgGroup6 = new URL('../assets/imgGroup6.png', import.meta.url).href;
const imgGroup7 = new URL('../assets/imgGroup7.png', import.meta.url).href;
const imgVector8 = new URL('../assets/imgVector8.png', import.meta.url).href;
...
export default function HomePage() {
  return (
    <div className="home-page-root mx-auto bg-white relative w-[1440px] min-h-[calc(8626px+200vh-580px)]" data-node-id="1:2" data-name="Home Page">
      ...
      <p className="[word-break:break-word] absolute font-['Playfair_Display:Regular'] font-normal leading-[normal] left-[calc(50%-141px)] text-[#201a14] text-[40px] top-[4466px] whitespace-nowrap" data-node-id="524:715">
        Custom Order
      </p>
      <p className="[word-break:break-word] absolute font-['Playfair:Bold'] font-bold h-[106px] leading-[0] left-[calc(50%-106px)] text-[#201a14] text-[0px] top-[5535px] w-[772px]" data-node-id="5:107" style={{ fontVariationSettings: '"opsz" 12, "wdth" 100' }}>
      ...
      <p className="[word-break:break-word] absolute font-['Poppins:Regular'] leading-[normal] left-[calc(50%-108px)] not-italic text-[#201a14] text-[15px] top-[5660px] w-[743px]" data-node-id="5:108">
      ...
      <div className="-translate-x-1/2 absolute h-[499px] left-[calc(50%-396px)] rounded-[16px] top-[5469px] w-[412px]" data-node-id="5:109">
      ...
      <div className="-translate-x-1/2 absolute h-[408px] left-[calc(50%-2.5px)] top-[4993px] w-[1453px]" data-node-id="32:147">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgRectangle301} />
      </div>
      <p className="[word-break:break-word] absolute font-['Kanit:Light'] h-[17px] leading-[16px] left-[calc(50%-297px)] not-italic text-[16px] text-white top-[6620px] w-[609px]" data-node-id="5:111">
        Grow your business with our premium gold products and exceptional customer service
      </p>
      <p className="[word-break:break-word] absolute font-['Playfair_Display_SC:Regular'] h-[35px] leading-[32px] left-[calc(50%-214px)] not-italic text-[42px] text-white top-[6562px] w-[444px]" data-node-id="5:112">
        Grow Your Business
      </p>
      ...
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Playfair_Display:Regular'] font-normal leading-[normal] left-[calc(50%+5.5px)] text-[#201a14] text-[40px] text-center top-[2493px] w-[163px]" data-node-id="32:144">
        Shop by
      </p>
      ...
      <div className="absolute contents left-[382px] top-[6685px]" data-node-id="5:124" data-name="Mask group">
      ...
      <div className="absolute contents left-[381px] top-[6804px]" data-node-id="130:27" data-name="Mask group">
      ...
      <p className="[word-break:break-word] absolute font-['Playfair_Display:SemiBold'] font-semibold h-[45px] leading-[42px] left-[calc(50%-252px)] text-[20px] text-white top-[6705px] uppercase w-[242px]" data-node-id="5:119">
        JEWELLERS
      </p>
      <p className="[word-break:break-word] absolute font-['Playfair_Display:SemiBold'] font-semibold h-[45px] leading-[42px] left-[calc(50%-253px)] text-[20px] text-white top-[6824px] uppercase w-[242px]" data-node-id="130:30">
        mANUFACTURER
      </p>
      <p className="[word-break:break-word] absolute font-['Poppins:SemiBold'] h-[45px] leading-[0px] left-[calc(50%-252px)] not-italic text-[#e1b63b] text-[11px] top-[6701px] tracking-[1.21px] uppercase w-[242px]" data-node-id="130:25">
        fOR retailers
      </p>
      <p className="[word-break:break-word] absolute font-['Poppins:SemiBold'] h-[45px] leading-[0px] left-[calc(50%-255px)] not-italic text-[#e1b63b] text-[11px] top-[6820px] tracking-[1.21px] uppercase w-[242px]" data-node-id="130:31">
        for manufacturer
      </p>
      <div className="absolute left-[1026px] size-[33px] top-[6699px]" data-node-id="5:116">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgEllipse26} />
      </div>
      <div className="absolute left-[1025px] size-[33px] top-[6818px]" data-node-id="130:32">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgEllipse26} />
      </div>
      ...
      <div className="absolute h-[296px] left-[27px] rounded-bl-[27px] rounded-tl-[27px] top-[2150px] w-[663px]" data-node-id="3:7">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-bl-[27px] rounded-tl-[27px] size-full" src={imgRectangle222} />
      </div>
      <div className="absolute bg-gradient-to-b from-[#c9a84c] h-[296px] left-[690px] rounded-br-[27px] rounded-tr-[27px] to-[#fffaed] top-[2150px] w-[716px]" data-node-id="3:8" />
      <div className="absolute h-[50px] left-[718px] top-[2377px] w-[49px]" data-node-id="5:15">
        <div className="absolute inset-[0_-8.16%_-16%_-8.16%]">
          <img alt="" className="block max-w-none size-full" src={imgEllipse7} />
        </div>
      </div>
      <div className="absolute h-[50px] left-[808px] top-[2378px] w-[49px]" data-node-id="5:16">
        <div className="absolute inset-[0_-8.16%_-16%_-8.16%]">
          <img alt="" className="block max-w-none size-full" src={imgEllipse8} />
        </div>
      </div>
      <div className="absolute border border-[#ac7d0c] border-solid left-[718px] rounded-[10px] size-[139px] top-[2175px]" data-node-id="5:9">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[10px] size-full" src={imgRectangle220} />
      </div>
      <div className="absolute bg-[#ac7d0c] border border-[#ac7d0c] border-solid h-[48px] left-[1151px] rounded-[8px] top-[2378px] w-[226px]" data-node-id="5:13" />
      <div className="absolute h-[139px] left-[891px] rounded-[10px] top-[2175px] w-[140px]" data-node-id="5:10">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[10px] size-full" src={imgRectangle224} />
      </div>
      <div className="absolute h-[139px] left-[1064px] rounded-[10px] top-[2175px] w-[140px]" data-node-id="5:11">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[10px] size-full" src={imgRectangle225} />
      </div>
      <div className="absolute left-[1238px] rounded-[10px] size-[139px] top-[2175px]" data-node-id="5:12">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[10px] size-full" src={imgRectangle226} />
      </div>
      <p className="[word-break:break-word] absolute font-['Kanit:Regular'] leading-[16px] left-[1219px] not-italic text-[20px] text-white top-[2393px] whitespace-nowrap" data-node-id="5:14">
        Shop Now
      </p>
      <div className="absolute h-[15px] left-[734px] top-[2395px] w-[17.5px]" data-node-id="12:21">
        <div className="absolute inset-[-7.68%_0_-7.07%_-5.82%]">
          <img alt="" className="block max-w-none size-full" src={imgGroup6} />
        </div>
      </div>
      <div className="absolute flex h-[15.299px] items-center justify-center left-[824px] top-[2396.07px] w-[14.576px]" data-node-id="12:22">
        <div className="flex-none rotate-[178.79deg]">
          <div className="h-[15px] relative w-[14.261px]">
            <div className="absolute inset-[-6.99%_0_-6.32%_-8.14%]">
              <img alt="" className="block max-w-none size-full" src={imgGroup7} />
            </div>
          </div>
        </div>
      </div>
      <p className="[word-break:break-word] absolute font-['Inter:Bold'] font-bold leading-[0] left-[726px] not-italic text-[#7b7b7b] text-[12px] top-[2338px] whitespace-nowrap" data-node-id="14:42">
        <span className="font-['Inter:Medium'] font-medium leading-[normal]">Wastage</span>
        <span className="leading-[normal]">:</span>
      </p>
      <p className="[word-break:break-word] absolute font-['Inter:Bold'] font-bold leading-[0] left-[899px] not-italic text-[#7b7b7b] text-[12px] top-[2338px] whitespace-nowrap" data-node-id="14:239">
        <span className="font-['Inter:Medium'] font-medium leading-[normal]">Wastage</span>
        <span className="leading-[normal]">:</span>
      </p>
      <p className="[word-break:break-word] absolute font-['Inter:Bold'] font-bold leading-[0] left-[1072px] not-italic text-[#7b7b7b] text-[12px] top-[2338px] whitespace-nowrap" data-node-id="14:243">
        <span className="font-['Inter:Medium'] font-medium leading-[normal]">Wastage</span>
        <span className="leading-[normal]">:</span>
      </p>
      <p className="[word-break:break-word] absolute font-['Inter:Bold'] font-bold leading-[0] left-[1246px] not-italic text-[#7b7b7b] text-[12px] top-[2338px] whitespace-nowrap" data-node-id="14:247">
        <span className="font-['Inter:Medium'] font-medium leading-[normal]">Wastage</span>
        <span className="leading-[normal]">:</span>
      </p>
      <p className="[word-break:break-word] absolute font-['Inter:Semi_Bold'] font-semibold leading-[normal] left-[726px] not-italic text-[#a47347] text-[14px] top-[2319px] whitespace-nowrap" data-node-id="14:238">
        Diamond Ring
      </p>
      <p className="[word-break:break-word] absolute font-['Inter:Semi_Bold'] font-semibold leading-[normal] left-[899px] not-italic text-[#a47347] text-[14px] top-[2319px] whitespace-nowrap" data-node-id="14:240">
        Diamond Ring
      </p>
      <p className="[word-break:break-word] absolute font-['Inter:Semi_Bold'] font-semibold leading-[normal] left-[1072px] not-italic text-[#a47347] text-[14px] top-[2319px] whitespace-nowrap" data-node-id="14:244">
        Diamond Ring
      </p>
      <p className="[word-break:break-word] absolute font-['Inter:Semi_Bold'] font-semibold leading-[normal] left-[1246px] not-italic text-[#a47347] text-[14px] top-[2319px] whitespace-nowrap" data-node-id="14:248">
        Diamond Ring
      </p>
      <p className="[word-break:break-word] absolute font-['Inter:Semi_Bold'] font-semibold leading-[normal] left-[787px] not-italic text-[#e00000] text-[12px] top-[2338px] whitespace-nowrap" data-node-id="14:44">
        4.5%
      </p>
      <p className="[word-break:break-word] absolute font-['Inter:Semi_Bold'] font-semibold leading-[normal] left-[960px] not-italic text-[#e00000] text-[12px] top-[2338px] whitespace-nowrap" data-node-id="14:241">
        4.5%
      </p>
      <p className="[word-break:break-word] absolute font-['Inter:Semi_Bold'] font-semibold leading-[normal] left-[1133px] not-italic text-[#e00000] text-[12px] top-[2338px] whitespace-nowrap" data-node-id="14:245">
        4.5%
      </p>
      <p className="[word-break:break-word] absolute font-['Inter:Semi_Bold'] font-semibold leading-[normal] left-[1307px] not-italic text-[#e00000] text-[12px] top-[2338px] whitespace-nowrap" data-node-id="14:249">
        4.5%
      </p>
      <p className="[word-break:break-word] absolute font-['Inter:Semi_Bold'] font-semibold leading-[normal] left-[821px] not-italic text-[#137a32] text-[12px] top-[2338px] whitespace-nowrap" data-node-id="14:45">
        3.5%
      </p>
      <p className="[word-break:break-word] absolute font-['Inter:Semi_Bold'] font-semibold leading-[normal] left-[994px] not-italic text-[#137a32] text-[12px] top-[2338px] whitespace-nowrap" data-node-id="14:242">
        3.5%
      </p>
      <p className="[word-break:break-word] absolute font-['Inter:Semi_Bold'] font-semibold leading-[normal] left-[1167px] not-italic text-[#137a32] text-[12px] top-[2338px] whitespace-nowrap" data-node-id="14:246">
        3.5%
      </p>
      <p className="[word-break:break-word] absolute font-['Inter:Semi_Bold'] font-semibold leading-[normal] left-[1341px] not-italic text-[#137a32] text-[12px] top-[2338px] whitespace-nowrap" data-node-id="14:250">
        3.5%
      </p>
      <div className="absolute h-0 left-[786px] top-[2345.5px] w-[31px]" data-node-id="14:237">
        <div className="absolute inset-[-0.35px_0]">
          <img alt="" className="block max-w-none size-full" src={imgVector8} />
        </div>
      </div>
      <div className="absolute flex h-[354px] items-center justify-center left-[52px] top-[4062px] w-[241px]" data-node-id="214:322">
      ...
      <div className="absolute flex h-[354px] items-center justify-center left-[52px] top-[4563px] w-[241px]" data-node-id="524:716">
        <div className="-scale-y-100 flex-none">
          <div className="bg-white border border-[#f4eedb] border-solid h-[354px] relative rounded-[15px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] w-[241px]" />
        </div>
      </div>
      <div className="absolute flex h-[354px] items-center justify-center left-[588px] top-[4061px] w-[241px]" data-node-id="214:323">
        <div className="-scale-y-100 flex-none">
          <div className="bg-white border border-[#f4eedb] border-solid h-[354px] relative rounded-[15px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] w-[241px]" />
        </div>
      </div>
      <div className="absolute flex h-[354px] items-center justify-center left-[588px] top-[4562px] w-[241px]" data-node-id="524:717">
        <div className="-scale-y-100 flex-none">
          <div className="bg-white border border-[#f4eedb] border-solid h-[354px] relative rounded-[15px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] w-[241px]" />
        </div>
      </div>
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[604px] rounded-[3px] top-[4345px] w-[63px]" data-node-id="214:324" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[604px] rounded-[3px] top-[4846px] w-[63px]" data-node-id="524:718" />
      <p className="[word-break:break-word] absolute font-['Kanit:Medium'] leading-[16px] left-[613px] not-italic text-[#ac7d0c] text-[12px] top-[4350px] whitespace-nowrap" data-node-id="214:325">
        Carat 22
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Medium'] leading-[16px] left-[613px] not-italic text-[#ac7d0c] text-[12px] top-[4851px] whitespace-nowrap" data-node-id="524:719">
        Carat 22
      </p>
      <div className="absolute flex h-[354px] items-center justify-center left-[319px] top-[4063px] w-[241px]" data-node-id="214:326">
        <div className="-scale-y-100 flex-none">
          <div className="bg-white border border-[#f4eedb] border-solid h-[354px] relative rounded-[15px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] w-[241px]" />
        </div>
      </div>
      <div className="absolute flex h-[354px] items-center justify-center left-[319px] top-[4564px] w-[241px]" data-node-id="524:720">
        <div className="-scale-y-100 flex-none">
          <div className="bg-white border border-[#f4eedb] border-solid h-[354px] relative rounded-[15px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] w-[241px]" />
        </div>
      </div>
      <div className="absolute flex h-[354px] items-center justify-center left-[855px] top-[4062px] w-[241px]" data-node-id="214:327">
        <div className="-scale-y-100 flex-none">
          <div className="bg-white border border-[#f4eedb] border-solid h-[354px] relative rounded-[15px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] w-[241px]" />
        </div>
      </div>
      <div className="absolute flex h-[354px] items-center justify-center left-[855px] top-[4563px] w-[241px]" data-node-id="524:721">
        <div className="-scale-y-100 flex-none">
          <div className="bg-white border border-[#f4eedb] border-solid h-[354px] relative rounded-[15px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] w-[241px]" />
        </div>
      </div>
      <div className="absolute flex h-[354px] items-center justify-center left-[1123px] top-[4064px] w-[241px]" data-node-id="214:328">
        <div className="-scale-y-100 flex-none">
          <div className="bg-white border border-[#f4eedb] border-solid h-[354px] relative rounded-[15px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] w-[241px]" />
        </div>
      </div>
      <div className="absolute flex h-[354px] items-center justify-center left-[1123px] top-[4565px] w-[241px]" data-node-id="524:722">
        <div className="-scale-y-100 flex-none">
          <div className="bg-white border border-[#f4eedb] border-solid h-[354px] relative rounded-[15px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] w-[241px]" />
        </div>
      </div>
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[68px] rounded-[3px] top-[4377px] w-[108px]" data-node-id="214:329" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[68px] rounded-[3px] top-[4878px] w-[108px]" data-node-id="524:723" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[604px] rounded-[3px] top-[4376px] w-[108px]" data-node-id="214:330" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[604px] rounded-[3px] top-[4877px] w-[108px]" data-node-id="524:724" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[335px] rounded-[3px] top-[4378px] w-[108px]" data-node-id="214:331" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[335px] rounded-[3px] top-[4879px] w-[108px]" data-node-id="524:725" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[871px] rounded-[3px] top-[4377px] w-[108px]" data-node-id="214:332" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[871px] rounded-[3px] top-[4878px] w-[108px]" data-node-id="524:726" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[1139px] rounded-[3px] top-[4379px] w-[108px]" data-node-id="214:333" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[1139px] rounded-[3px] top-[4880px] w-[108px]" data-node-id="524:727" />
      <Rectangle365Default className="absolute h-[242px] left-[53px] top-[4063px] w-[241px]" />
      <Rectangle365Default className="absolute h-[242px] left-[53px] top-[4564px] w-[241px]" />
      <Rectangle365Default className="absolute h-[242px] left-[589px] top-[4062px] w-[241px]" />
      <Rectangle365Default className="absolute h-[242px] left-[589px] top-[4563px] w-[241px]" />
      <Rectangle365Default className="absolute h-[242px] left-[320px] top-[4064px] w-[241px]" />
      <Rectangle365Default className="absolute h-[242px] left-[320px] top-[4565px] w-[241px]" />
      <Rectangle365Default className="absolute h-[242px] left-[856px] top-[4063px] w-[241px]" />
      <Rectangle365Default className="absolute h-[242px] left-[856px] top-[4564px] w-[241px]" />
      <Rectangle365Default className="absolute h-[242px] left-[1124px] top-[4065px] w-[241px]" />
      <Rectangle365Default className="absolute h-[242px] left-[1124px] top-[4566px] w-[241px]" />
      <div className="absolute h-0 left-[125.5px] top-[4391.5px] w-[21px]" data-node-id="214:339">
        <div className="absolute inset-[-0.75px_0]">
          <img alt="" className="block max-w-none size-full" src={imgVector36} />
        </div>
      </div>
      <div className="absolute h-0 left-[125.5px] top-[4892.5px] w-[21px]" data-node-id="524:733">
        <div className="absolute inset-[-0.75px_0]">
          <img alt="" className="block max-w-none size-full" src={imgVector36} />
        </div>
      </div>
      <div className="absolute h-0 left-[661.5px] top-[4390.5px] w-[21px]" data-node-id="214:340">
        <div className="absolute inset-[-0.75px_0]">
          <img alt="" className="block max-w-none size-full" src={imgVector36} />
        </div>
      </div>
      <div className="absolute h-0 left-[661.5px] top-[4891.5px] w-[21px]" data-node-id="524:734">
        <div className="absolute inset-[-0.75px_0]">
          <img alt="" className="block max-w-none size-full" src={imgVector36} />
        </div>
      </div>
      <div className="absolute h-0 left-[392.5px] top-[4392.5px] w-[21px]" data-node-id="214:341">
        <div className="absolute inset-[-0.75px_0]">
          <img alt="" className="block max-w-none size-full" src={imgVector36} />
        </div>
      </div>
      <div className="absolute h-0 left-[392.5px] top-[4893.5px] w-[21px]" data-node-id="524:735">
        <div className="absolute inset-[-0.75px_0]">
          <img alt="" className="block max-w-none size-full" src={imgVector36} />
        </div>
      </div>
      <div className="absolute h-0 left-[928.5px] top-[4391.5px] w-[21px]" data-node-id="214:342">
        <div className="absolute inset-[-0.75px_0]">
          <img alt="" className="block max-w-none size-full" src={imgVector36} />
        </div>
      </div>
      <div className="absolute h-0 left-[928.5px] top-[4892.5px] w-[21px]" data-node-id="524:736">
        <div className="absolute inset-[-0.75px_0]">
          <img alt="" className="block max-w-none size-full" src={imgVector36} />
        </div>
      </div>
      <div className="absolute h-0 left-[1196.5px] top-[4393.5px] w-[21px]" data-node-id="214:343">
        <div className="absolute inset-[-0.75px_0]">
          <img alt="" className="block max-w-none size-full" src={imgVector36} />
        </div>
      </div>
      <div className="absolute h-0 left-[1196.5px] top-[4894.5px] w-[21px]" data-node-id="524:737">
        <div className="absolute inset-[-0.75px_0]">
          <img alt="" className="block max-w-none size-full" src={imgVector36} />
        </div>
      </div>
      <p className="[word-break:break-word] absolute font-['Playfair_Display:Regular'] font-normal leading-[16px] left-[68px] text-[14px] text-black top-[4315px] whitespace-nowrap" data-node-id="214:344">
        Kalamani Padar Piece Ganthan
      </p>
      <p className="[word-break:break-word] absolute font-['Playfair_Display:Regular'] font-normal leading-[16px] left-[68px] text-[14px] text-black top-[4816px] whitespace-nowrap" data-node-id="524:738">
        Kalamani Padar Piece Ganthan
      </p>
      <p className="[word-break:break-word] absolute font-['Playfair_Display:Regular'] font-normal leading-[16px] left-[604px] text-[14px] text-black top-[4314px] whitespace-nowrap" data-node-id="214:345">
        Kalamani Padar Piece Ganthan
      </p>
      <p className="[word-break:break-word] absolute font-['Playfair_Display:Regular'] font-normal leading-[16px] left-[604px] text-[14px] text-black top-[4815px] whitespace-nowrap" data-node-id="524:739">
        Kalamani Padar Piece Ganthan
      </p>
      <p className="[word-break:break-word] absolute font-['Playfair_Display:Regular'] font-normal leading-[16px] left-[335px] text-[14px] text-black top-[4316px] whitespace-nowrap" data-node-id="214:346">
        Kalamani Padar Piece Ganthan
      </p>
      <p className="[word-break:break-word] absolute font-['Playfair_Display:Regular'] font-normal leading-[16px] left-[335px] text-[14px] text-black top-[4817px] whitespace-nowrap" data-node-id="524:740">
        Kalamani Padar Piece Ganthan
      </p>
      <p className="[word-break:break-word] absolute font-['Playfair_Display:Regular'] font-normal leading-[16px] left-[871px] text-[14px] text-black top-[4315px] whitespace-nowrap" data-node-id="214:347">
        Kalamani Padar Piece Ganthan
      </p>
      <p className="[word-break:break-word] absolute font-['Playfair_Display:Regular'] font-normal leading-[16px] left-[871px] text-[14px] text-black top-[4816px] whitespace-nowrap" data-node-id="524:741">
        Kalamani Padar Piece Ganthan
      </p>
      <p className="[word-break:break-word] absolute font-['Playfair_Display:Regular'] font-normal leading-[16px] left-[1139px] text-[14px] text-black top-[4317px] whitespace-nowrap" data-node-id="214:348">
        Kalamani Padar Piece Ganthan
      </p>
      <p className="[word-break:break-word] absolute font-['Playfair_Display:Regular'] font-normal leading-[16px] left-[1139px] text-[14px] text-black top-[4818px] whitespace-nowrap" data-node-id="524:742">
        Kalamani Padar Piece Ganthan
      </p>
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[138px] rounded-[3px] top-[4346px] w-[59px]" data-node-id="214:349" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[138px] rounded-[3px] top-[4847px] w-[59px]" data-node-id="524:743" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[674px] rounded-[3px] top-[4345px] w-[59px]" data-node-id="214:350" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[674px] rounded-[3px] top-[4846px] w-[59px]" data-node-id="524:744" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[405px] rounded-[3px] top-[4347px] w-[59px]" data-node-id="214:351" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[405px] rounded-[3px] top-[4848px] w-[59px]" data-node-id="524:745" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[941px] rounded-[3px] top-[4346px] w-[59px]" data-node-id="214:352" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[941px] rounded-[3px] top-[4847px] w-[59px]" data-node-id="524:746" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[1209px] rounded-[3px] top-[4348px] w-[59px]" data-node-id="214:353" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[1209px] rounded-[3px] top-[4849px] w-[59px]" data-node-id="524:747" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[68px] rounded-[3px] top-[4346px] w-[63px]" data-node-id="214:354" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[68px] rounded-[3px] top-[4847px] w-[63px]" data-node-id="524:748" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[335px] rounded-[3px] top-[4346px] w-[63px]" data-node-id="214:355" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[335px] rounded-[3px] top-[4847px] w-[63px]" data-node-id="524:749" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[871px] rounded-[3px] top-[4345px] w-[63px]" data-node-id="214:356" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[871px] rounded-[3px] top-[4846px] w-[63px]" data-node-id="524:750" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[1139px] rounded-[3px] top-[4347px] w-[63px]" data-node-id="214:357" />
      <div className="absolute bg-[#f3ead5] border-[#ebdbb0] border-[0.5px] border-solid h-[25px] left-[1139px] rounded-[3px] top-[4848px] w-[63px]" data-node-id="524:751" />
      <p className="[word-break:break-word] absolute font-['Kanit:Medium'] leading-[16px] left-[77px] not-italic text-[#ac7d0c] text-[12px] top-[4351px] whitespace-nowrap" data-node-id="214:358">
        Carat 22
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Medium'] leading-[16px] left-[77px] not-italic text-[#ac7d0c] text-[12px] top-[4852px] whitespace-nowrap" data-node-id="524:752">
        Carat 22
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Medium'] leading-[16px] left-[344px] not-italic text-[#ac7d0c] text-[12px] top-[4351px] whitespace-nowrap" data-node-id="214:359">
        Carat 22
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Medium'] leading-[16px] left-[344px] not-italic text-[#ac7d0c] text-[12px] top-[4852px] whitespace-nowrap" data-node-id="524:753">
        Carat 22
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Medium'] leading-[16px] left-[880px] not-italic text-[#ac7d0c] text-[12px] top-[4350px] whitespace-nowrap" data-node-id="214:360">
        Carat 22
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Medium'] leading-[16px] left-[880px] not-italic text-[#ac7d0c] text-[12px] top-[4851px] whitespace-nowrap" data-node-id="524:754">
        Carat 22
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Medium'] leading-[16px] left-[1148px] not-italic text-[#ac7d0c] text-[12px] top-[4352px] whitespace-nowrap" data-node-id="214:361">
        Carat 22
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Medium'] leading-[16px] left-[1148px] not-italic text-[#ac7d0c] text-[12px] top-[4853px] whitespace-nowrap" data-node-id="524:755">
        Carat 22
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Regular'] leading-[16px] left-[145px] not-italic text-[#7b7b7b] text-[12px] top-[4351px] whitespace-nowrap" data-node-id="214:362">
        18.78 gm
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Regular'] leading-[16px] left-[145px] not-italic text-[#7b7b7b] text-[12px] top-[4852px] whitespace-nowrap" data-node-id="524:756">
        18.78 gm
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Regular'] leading-[16px] left-[681px] not-italic text-[#7b7b7b] text-[12px] top-[4350px] whitespace-nowrap" data-node-id="214:363">
        18.78 gm
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Regular'] leading-[16px] left-[681px] not-italic text-[#7b7b7b] text-[12px] top-[4851px] whitespace-nowrap" data-node-id="524:757">
        18.78 gm
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Regular'] leading-[16px] left-[412px] not-italic text-[#7b7b7b] text-[12px] top-[4352px] whitespace-nowrap" data-node-id="214:364">
        18.78 gm
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Regular'] leading-[16px] left-[412px] not-italic text-[#7b7b7b] text-[12px] top-[4853px] whitespace-nowrap" data-node-id="524:758">
        18.78 gm
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Regular'] leading-[16px] left-[948px] not-italic text-[#7b7b7b] text-[12px] top-[4351px] whitespace-nowrap" data-node-id="214:365">
        18.78 gm
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Regular'] leading-[16px] left-[948px] not-italic text-[#7b7b7b] text-[12px] top-[4852px] whitespace-nowrap" data-node-id="524:759">
        18.78 gm
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Regular'] leading-[16px] left-[1216px] not-italic text-[#7b7b7b] text-[12px] top-[4353px] whitespace-nowrap" data-node-id="214:366">
        18.78 gm
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Regular'] leading-[16px] left-[1216px] not-italic text-[#7b7b7b] text-[12px] top-[4854px] whitespace-nowrap" data-node-id="524:760">
        18.78 gm
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Regular'] leading-[0] left-[77px] not-italic text-[#7b7b7b] text-[12px] top-[4382px] whitespace-pre" data-node-id="214:367">
      ...
      <p className="[word-break:break-word] absolute font-['Kanit:Regular'] leading-[0] left-[77px] not-italic text-[#7b7b7b] text-[12px] top-[4883px] whitespace-pre" data-node-id="524:761">
        <span className="leading-[16px]">{`Wastage  `}</span>
        <span className="leading-[16px] text-[#e00000]">{`4.0  `}</span>
        <span className="leading-[16px] text-[#137a32]">3.0</span>
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Regular'] leading-[0] left-[613px] not-italic text-[#7b7b7b] text-[12px] top-[4381px] whitespace-pre" data-node-id="214:368">
        <span className="leading-[16px]">{`Wastage  `}</span>
        <span className="leading-[16px] text-[#e00000]">{`4.0  `}</span>
        <span className="leading-[16px] text-[#137a32]">3.0</span>
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Regular'] leading-[0] left-[613px] not-italic text-[#7b7b7b] text-[12px] top-[4882px] whitespace-pre" data-node-id="524:762">
        <span className="leading-[16px]">{`Wastage  `}</span>
        <span className="leading-[16px] text-[#e00000]">{`4.0  `}</span>
        <span className="leading-[16px] text-[#137a32]">3.0</span>
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Regular'] leading-[0] left-[344px] not-italic text-[#7b7b7b] text-[12px] top-[4383px] whitespace-pre" data-node-id="214:369">
        <span className="leading-[16px]">{`Wastage  `}</span>
        <span className="leading-[16px] text-[#e00000]">{`4.0  `}</span>
        <span className="leading-[16px] text-[#137a32]">3.0</span>
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Regular'] leading-[0] left-[344px] not-italic text-[#7b7b7b] text-[12px] top-[4884px] whitespace-pre" data-node-id="524:763">
        <span className="leading-[16px]">{`Wastage  `}</span>
        <span className="leading-[16px] text-[#e00000]">{`4.0  `}</span>
        <span className="leading-[16px] text-[#137a32]">3.0</span>
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Regular'] leading-[0] left-[880px] not-italic text-[#7b7b7b] text-[12px] top-[4382px] whitespace-pre" data-node-id="214:370">
        <span className="leading-[16px]">{`Wastage  `}</span>
        <span className="leading-[16px] text-[#e00000]">{`4.0  `}</span>
        <span className="leading-[16px] text-[#137a32]">3.0</span>
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Regular'] leading-[0] left-[880px] not-italic text-[#7b7b7b] text-[12px] top-[4883px] whitespace-pre" data-node-id="524:764">
        <span className="leading-[16px]">{`Wastage  `}</span>
        <span className="leading-[16px] text-[#e00000]">{`4.0  `}</span>
        <span className="leading-[16px] text-[#137a32]">3.0</span>
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Regular'] leading-[0] left-[1148px] not-italic text-[#7b7b7b] text-[12px] top-[4384px] whitespace-pre" data-node-id="214:371">
        <span className="leading-[16px]">{`Wastage  `}</span>
        <span className="leading-[16px] text-[#e00000]">{`4.0  `}</span>
        <span className="leading-[16px] text-[#137a32]">3.0</span>
      </p>
      <p className="[word-break:break-word] absolute font-['Kanit:Regular'] leading-[0] left-[1148px] not-italic text-[#7b7b7b] text-[12px] top-[4885px] whitespace-pre" data-node-id="524:765">
        <span className="leading-[16px]">{`Wastage  `}</span>
        <span className="leading-[16px] text-[#e00000]">{`4.0  `}</span>
        <span className="leading-[16px] text-[#137a32]">3.0</span>
      </p>
      <div className="absolute left-[244px] size-[37px] top-[4076px]" data-node-id="214:372">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgEllipse99} />
      </div>
      <div className="absolute left-[244px] size-[37px] top-[4577px]" data-node-id="524:766">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgEllipse99} />
      </div>
      <div className="absolute left-[780px] size-[37px] top-[4075px]" data-node-id="214:373">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgEllipse99} />
      </div>
      <div className="absolute left-[780px] size-[37px] top-[4576px]" data-node-id="524:767">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgEllipse99} />
      </div>
      <div className="absolute left-[511px] size-[37px] top-[4077px]" data-node-id="214:374">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgEllipse99} />
      </div>
      <div className="absolute left-[511px] size-[37px] top-[4578px]" data-node-id="524:768">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgEllipse99} />
      </div>
      <div className="absolute left-[1047px] size-[37px] top-[4076px]" data-node-id="214:375">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgEllipse99} />
      </div>
      <div className="absolute left-[1047px] size-[37px] top-[4577px]" data-node-id="524:769">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgEllipse99} />
      </div>
      <div className="absolute left-[1315px] size-[37px] top-[4078px]" data-node-id="214:376">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgEllipse99} />
      </div>
      <div className="absolute left-[1315px] size-[37px] top-[4579px]" data-node-id="524:770">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgEllipse99} />
      </div>
      <div className="absolute h-[19px] left-[256px] top-[4082px] w-[13.686px]" data-node-id="214:377">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgGroup26006} />
      </div>
      <div className="absolute h-[19px] left-[256px] top-[4583px] w-[13.686px]" data-node-id="524:771">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgGroup26006} />
      </div>
      <div className="absolute h-[19px] left-[792px] top-[4081px] w-[13.686px]" data-node-id="214:380">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgGroup26006} />
      </div>
      <div className="absolute h-[19px] left-[792px] top-[4582px] w-[13.686px]" data-node-id="524:774">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgGroup26006} />
      </div>
      <div className="absolute h-[19px] left-[523px] top-[4083px] w-[13.686px]" data-node-id="214:383">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgGroup26006} />
      </div>
      <div className="absolute h-[19px] left-[523px] top-[4584px] w-[13.686px]" data-node-id="524:777">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgGroup26006} />
      </div>
      <div className="absolute h-[19px] left-[1059px] top-[4082px] w-[13.686px]" data-node-id="214:386">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgGroup26006} />
      </div>
      <div className="absolute h-[19px] left-[1059px] top-[4583px] w-[13.686px]" data-node-id="524:780">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgGroup26006} />
      </div>
      <div className="absolute h-[19px] left-[1327px] top-[4084px] w-[13.686px]" data-node-id="214:389">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgGroup26006} />
      </div>
      <div className="absolute h-[19px] left-[1327px] top-[4585px] w-[13.686px]" data-node-id="524:783">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgGroup26006} />
      </div>
      <div className="absolute left-[1355px] size-[28px] top-[4175px]" data-node-id="214:392">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgEllipse104} />
      </div>
      <div className="absolute left-[1355px] size-[28px] top-[4676px]" data-node-id="524:786">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgEllipse104} />
      </div>
      <div className="absolute flex h-[13.114px] items-center justify-center left-[1366px] top-[4182px] w-[5.779px]" data-node-id="214:393">
      ...
      <div className="absolute flex h-[13.114px] items-center justify-center left-[1366px] top-[4683px] w-[5.779px]" data-node-id="524:787">
        <div className="flex-none rotate-[90.68deg]">
          <div className="h-[5.626px] relative w-[13.049px]">
            <div className="absolute inset-[-23.47%_-4.95%_-13.56%_-5.06%]">
              <img alt="" className="block max-w-none size-full" src={imgVector41} />
      ...
      <div className="absolute left-[35px] size-[28px] top-[4175px]" data-node-id="214:394">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgEllipse104} />
      </div>
      <div className="absolute left-[35px] size-[28px] top-[4676px]" data-node-id="524:788">
        <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgEllipse104} />
      </div>
      <div className="absolute flex h-[13.184px] items-center justify-center left-[46px] top-[4182px] w-[5.948px]" data-node-id="214:395">
      ...
      <div className="absolute flex h-[13.184px] items-center justify-center left-[46px] top-[4683px] w-[5.948px]" data-node-id="524:789">
        <div className="flex-none rotate-[-91.42deg]">
          <div className="h-[5.626px] relative w-[13.049px]">
            <div className="absolute inset-[-23.47%_-4.95%_-13.56%_-5.06%]">
              <img alt="" className="block max-w-none size-full" src={imgVector42} />
